...
import { handleDscEvents } from '../handlers/dsc';
import { handleDscConfigEvents } from '../handlers/dscConfig';
import { handleOracleEvents } from '../handlers/oracle';
...
const EVENTS_TO_TRACK: EventTracker[] = [
  {
    type: `${CONFIG.CONTRACT.packageId}::dsc`,
    filter: {
      MoveEventModule: {
        module: 'dsc',
    ...
    callback: handleDscEvents,
  },
  {
    type: `${CONFIG.CONTRACT.packageId}::dsc_config`,
    filter: {
      MoveEventModule: {
        module: 'dsc_config',
        package: CONFIG.CONTRACT.packageId,
    ...
    callback: handleDscConfigEvents,
  },
  {
    type: `${CONFIG.CONTRACT.packageId}::oracle`,
    filter: {
      MoveEventModule: {
        module: 'oracle',
        package: CONFIG.CONTRACT.packageId,
